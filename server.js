...
// 🧾 Fake ticket database — replace SAMPLE_QR_1 with your real QR code
const tickets = {
  // Example — replace with your actual QR code value:
...
app.get("/tickets", (req, res) => {
  ...
  const html = `
    ...
    <body>
      ...
      <p>All tickets stored in backend:</p>
      <table>
        <thead>
          <tr>
            <th>QR Data</th>
...
// Default route
app.get("/", (req, res) => {
  res.send("Ticket backend is running. Visit /tickets to view the dashboard.");
});
